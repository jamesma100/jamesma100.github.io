---
layout: post
title: "Backpropogation from scratch: Part II"
---
In our previous post, we introduced backpropogation as a means for efficiently training neural networks.
...
The goal here is _not_ to give a primer on neural networks and how to best design them. Rather, we will focus on the training process via the backpropogation we derived last time. 
